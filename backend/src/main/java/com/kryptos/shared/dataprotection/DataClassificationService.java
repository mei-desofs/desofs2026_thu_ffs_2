...
public class DataClassificationService {
    ...
    static {
        ...
        PROTECTION_REQUIREMENTS.put(DataClassification.CONFIDENTIAL, List.of(
                ...
                new ProtectionRequirement("Access Control", "Strict need-to-know access; audit all access events."),
        ...
        PROTECTION_REQUIREMENTS.put(DataClassification.RESTRICTED, List.of(
                ...
                new ProtectionRequirement("Access Control", "Strictly limited to administrators and the specific service component; all access must be audited."),
